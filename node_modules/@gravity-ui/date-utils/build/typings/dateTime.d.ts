...
type BaseUnit = 'year' | 'years' | 'y' | 'month' | 'months' | 'M' | 'day' | 'days' | 'd' | 'hour' | 'hours' | 'h' | 'minute' | 'minutes' | 'm' | 'second' | 'seconds' | 's' | 'millisecond' | 'milliseconds' | 'ms';
...
export type AllUnit = BaseUnit | QuarterUnit | DateUnit | WeekUnit | IsoWeekUnit | 'isoWeekday' | 'isoWeekdays' | 'E';
...
export type SetObject = Partial<Record<BaseUnit | QuarterUnit | DateUnit | WeekUnit | IsoWeekUnit | 'weekday' | 'weekdays' | 'e' | 'isoWeekday' | 'isoWeekdays' | 'E', number>>;
