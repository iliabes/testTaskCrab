...
class AdaptiveTabs extends react_1.default.Component {
    ...
    renderSelect() {
        ...
        return (react_1.default.createElement(uikit_1.Select, Object.assign({ onUpdate: this.onChooseTabFromSelect, options: itemsForSelect, value: [], filterable: false, renderControl: this.renderSwitcherForMoreSelect, onOpenChange: this.handleOpenSelectChange }, moreControlProps)));
    }
    renderTabsAsSelect() {
        const activeTabID = this.activeTab;
        const { items } = this.props;
