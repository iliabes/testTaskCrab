...
const DefaultRowActions = ({ index, item, getRowActions, getRowDescriptor, rowActionsSize, isRowDisabled, }) => {
    ...
    return (react_1.default.createElement("div", { className: actionsCn },
        react_1.default.createElement(Popup_1.Popup, { open: open, anchorRef: anchorRef, placement: DEFAULT_PLACEMENT, onOutsideClick: () => setOpen(false), id: rowId },
            react_1.default.createElement(Menu_1.Menu, { className: menuCn, size: rowActionsSize }, actions.map(renderPopupMenuItem))),
        react_1.default.createElement(Button_1.Button, { view: "flat-secondary", className: actionsButtonCn, onClick: () => setOpen(!open), size: rowActionsSize, ref: anchorRef, disabled: disabled, extraProps: {
