...
function withTableSettings(ComponentOrOptions) {
    function tableWithSettingsFactory(TableComponent, { width, sortable } = {}) {
        ...
        function TableWithSettings(_a) {
            var { updateSettings, settings, columns, settingsPopupWidth, renderControls } = _a, restTableProps = tslib_1.__rest(_a, ["updateSettings", "settings", "columns", "settingsPopupWidth", "renderControls"]);
                ...
                return (0, withTableActions_1.enhanceSystemColumn)(filterColumns(columns, actualItems), (systemColumn) => {
                    systemColumn.name = () => (react_1.default.createElement("div", { className: b('settings') },
                        react_1.default.createElement(TableColumnSetup_1.TableColumnSetup, { popupWidth: settingsPopupWidth || width, popupPlacement: POPUP_PLACEMENT, sortable: sortable, onUpdate: updateSettings, items: actualItems, renderSwitcher: ({ onClick }) => (react_1.default.createElement(Button_1.Button, { view: "flat", className: b('settings-button'), extraProps: { 'aria-label': (0, i18n_1.default)('label_settings') }, onClick: onClick },
                                react_1.default.createElement(Icon_1.Icon, { data: icons_1.Gear }))), renderControls: renderControls })));
                });
