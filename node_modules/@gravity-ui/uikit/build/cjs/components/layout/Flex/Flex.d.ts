 ...
 */
export declare const Flex: React.ForwardRefExoticComponent<FlexProps<React.ElementType<any, keyof React.JSX.IntrinsicElements>> & React.RefAttributes<unknown>>;
