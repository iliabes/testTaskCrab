    ...
    return (react_1.default.createElement(AlertContextProvider_1.AlertContextProvider, { layout: layout, view: view },
        react_1.default.createElement(Card_1.Card, { style: style, className: (0, constants_1.bAlert)({ corners }, (0, layout_1.spacing)({ py: 4, px: 5 }, className)), theme: theme, view: view, qa: qa },
            react_1.default.createElement(layout_1.Flex, { gap: "3", alignItems: align },
                typeof props.icon === 'undefined' ? (react_1.default.createElement(exports.Alert.Icon, { theme: theme, view: view })) : (props.icon // ability to pass `null` as `icon` prop value
                ),
                ...
                onClose && (react_1.default.createElement(Button_1.Button, { view: "flat", onClick: onClose, extraProps: {
