...
export interface TextProps extends Omit<TextBaseProps, 'ellipsisLines'>, ColorTextBaseProps, QAProps {
    /**
 ...
 * ```
 */
export declare const Text: (<C extends React.ElementType<any, keyof React.JSX.IntrinsicElements> = "span">({ ref, ...props }: {
    as?: C | undefined;
} & Omit<TextProps, "as"> & {
