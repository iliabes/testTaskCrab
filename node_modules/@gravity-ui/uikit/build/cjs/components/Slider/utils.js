...
exports.getInnerState = exports.getMarksFromInfoPoints = void 0;
...
function getInnerState({ max = 100, min = 0, availableValues, defaultValue, marksCount, step, value, }) {
    const state = {
        value,
        defaultValue,
        range: false,
...
exports.getInnerState = getInnerState;
