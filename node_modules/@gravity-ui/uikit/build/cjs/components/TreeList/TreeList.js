...
const TreeList = ({ qa, id, size = 'm', items, className, expandedById, disabledById, activeItemId, selectedById, defaultGroupsExpanded = true, getItemId, renderItem: propsRenderItem, renderContainer = TreeListContainer_1.TreeListContainer, onItemClick, multiple, setActiveItemId, containerRef: propsContainerRef, mapItemDataToProps, }) => {
