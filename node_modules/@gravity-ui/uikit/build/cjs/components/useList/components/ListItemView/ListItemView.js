...
const ListItemViewSlot = (_a) => {
    ...
    return (react_1.default.createElement(layout_1.Flex, Object.assign({ className: b('slot', { indent }, className) }, props), children));
};
...
exports.ListItemView = react_1.default.forwardRef((_a, ref) => {
    var { qa, id, as = 'div', size = 'm', active, selected, disabled, activeOnHover: propsActiveOnHover, className, hasSelectionIcon = true, indentation, startSlot, subtitle, endSlot, title, height, expanded, dragging, style, role = 'option', onClick: _onClick } = _a, rest = tslib_1.__rest(_a, ["qa", "id", "as", "size", "active", "selected", "disabled", "activeOnHover", "className", "hasSelectionIcon", "indentation", "startSlot", "subtitle", "endSlot", "title", "height", "expanded", "dragging", "style", "role", "onClick"]);
    ...
    return (react_1.default.createElement(layout_1.Flex, Object.assign({ [constants_2.LIST_ITEM_DATA_ATR]: id, [constants_1.QA_DATA_ATTR]: qa, role: role, "aria-selected": selected, onClick: onClick, className: b({
        ...
        }, (0, layout_1.spacing)({ px: 2 }, className)), style: Object.assign({ minHeight: height !== null && height !== void 0 ? height : constants_2.modToHeight[size][Number(Boolean(subtitle))] }, style), as: as, ref: ref, alignItems: "center", gap: "4", justifyContent: "space-between" }, rest),
        react_1.default.createElement(layout_1.Flex, { gap: "2", alignItems: "center" },
...
exports.ListItemView.displayName = 'ListItemView';
