  ...
  return (
    ...
    <div className="home-container">
      <div className="Result">
        ...
        <Text className='Result-text'  whiteSpace={"break-spaces"} variant="body-3">В тестовом задании был сделан прототип приложения в котором реализован вывод таблицы заявками, ее редактирование, удаление и создание новых</Text>
        <br />
